...
public final class QueryUtils {
    ...
    public static List<Article> fetchArticleData(String requestUrl) {
        try {
            // I kept this in here, because I like the spinner before the results get displayed.
            Thread.sleep(2000);
    ...
    private static List<Article> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                // For a given article, extract the JSONObject
                ...
                String datePublished = results.getString("webPublicationDate");
                ...
                Article article = new Article(title, section, webUrl, datePublished, authorName, thumbnail);
